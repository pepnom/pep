...
public class ScriptToEs extends Object
{
  //--------------------------------------------
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    {             
       ...
       if (pp.workspace().equals("slash|slash|"))
       {
         ...
         sbErrors.append("condicíon vacía: //");
         sbErrors.append(" (linea " + iLineNumber + ")");
       ...
       if (pp.workspace().equals("hash|hash|"))
       {
         ...
         pp.add("comment|");
         pp.push();
         sbErrors.append("comentario sin contenido: ##");
         sbErrors.append(" (linea " + iLineNumber + ")");
         sbErrors.append(NEWLINE);
       }
       ...
       while (bReduction)
       {
        ...
        if (pp.workspace().equals("word|semi-colon|"))
        {
          ...
          {
            pp.add(" #imprimir búfer#");
          }
          else if (pp.workspace().toString().equals("clear"))
          {
            pp.add(" #despejar búfer#");
          }
          else if (pp.workspace().toString().equals("push"))
          {
            pp.add(" #empujar búfer a la pila#");
          }
          else if (pp.workspace().toString().equals("pop"))
          {
            pp.add(" #último de la pila al búfer#");
          }
          else if (pp.workspace().toString().equals("put"))
          {
            pp.add(" #poner búfer en la lista#");
          }
          else if (pp.workspace().toString().equals("get"))
          {
            pp.add(" #obtener desde la lista, y añadirlo al búfer#");
          }
          else if (pp.workspace().toString().equals("++"))
          { 
            pp.add(" #incrementar el puntero de la lista#");
          }
          else if (pp.workspace().toString().equals("--"))
          {
            pp.add(" #decrementar el puntero de la lista#");
          }
          else if (pp.workspace().toString().equals("newline"))
          {
            pp.add(" #añadir retorno de carro al búfer#");
          }
          else if (pp.workspace().toString().equals("indent"))
          {
            pp.add(" #dejar sangría en el búfer#");
          }
          else if (pp.workspace().toString().equals("add"))
          {
            sbErrors.append("sintácticamente incorrecto: ");
            sbErrors.append("el comando 'add' requiere un argumento.");
            sbErrors.append(" (linea " + iLineNumber + ")");
            sbErrors.append(NEWLINE);
          }
          else
        ...
        if (pp.workspace().equals("word|quoted-text|semi-colon|"))
        {
          ...
          if (pp.workspace().toString().equals("add"))
          {
            ...
            pp.decrementTape();
            pp.add(";");
            pp.add(" # añadir el texto al búfer#");
          }
          else
          {
            sbErrors.append("comando incorrecto: ");
            sbErrors.append(pp.workspace().toString());
            sbErrors.append(" (linea " + iLineNumber + ")");
            sbErrors.append(NEWLINE);
          }
    ...
    if (pp.stacksize() != 1)
    {
      System.out.println("*** hay errores en el script ***");
      System.out.println("*** estado final de la máquina ***");
      System.out.println(pp.printState());
      System.exit(0);
    }
        ...
        pp.workspace().equals("command-set|"))
    {
      if (pp.stacksize() == 0)
      {
        System.out.println("script sintáticamente correcto.");
        pp.clear();
        pp.get();
        pp.print();
      }
    ...
    System.out.println("Descripción de errores:");

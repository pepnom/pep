...
PARSING CHALLENGES
  ...
  parse palindromes: 
    see test.palindromes for a incomplete example
...
TASKS
   ...
   * see 12 august for various ideas eg "testhas", "untiltape", "testtapeends"

   * possibly expand the negation operator to include equals tests
     (not just class tests).  eg: !"tree" { nop; }  

   * make a help switch that prints out a list of machine commands
     and descriptions to stdout. Then include that in gh-book.txt
   ...
   * reorganise the code files into:
        ...
        machine.interp.c - 
           the interactive prog (included in gh.c at the moment)
        machine.prog - 
...
SEE ALSO
   ...
   machine.methods.c
     ...
     machine.
   asm.pp
     a parse machine assembler program to compile scripts.
   test.commands.pss
...
HISTORY
    ...
    10 august 2019
      ...
      trying to organise the gh.c source code into separate objects
      in the gh/object/ folder.
    ...
    26 july 2019
      ...
      comment block. eg:
          pp -If test.commands.pss input.txt
...
void newMachine(struct Machine * machine, FILE * input, 
  ...
  newProgram(&machine->program, 1500);
...
/*
  ...
  OTHER PARSING IDEAS
    ...
    But it is not necessary, because the machine itself can parse
    the script file.
  ----------------

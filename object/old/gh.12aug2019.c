...
BUGS 
    ...
    * saveAssembledProgram will not deal with the second 
      ...
      the "replace" command correctly.

    * classtests return true for an empty workspace!!
...
HISTORY
    ...
    12 august 2019
      ...
      Made the files in the gh/object folder
      the canonical source code for the machine. This means
      I need to make ppc etc compile with these files.

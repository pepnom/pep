...
jumpfalse block.end.40145
  ...
  jump block.end.39992
    ...
    testends "]"
    jumptrue 2 
    jump block.end.39847
      clip
      clip
      clop
      clop
      testis "-"
      jumpfalse block.end.38904
        clear
        ++
        get
...
jumpfalse block.end.40938
  clear
  get
  testis "replace"
  jumpfalse block.end.40761
    #---------------------------

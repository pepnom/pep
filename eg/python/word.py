...
while (not mm.eof): 
  ...
  while True: 
    ...
    # between each word.
    if (re.match(r"^[ \t\f]+$", mm.work)):
      # while  
      while re.match(r"^[ \t\f]+$", mm.peep):
        if mm.eof:  break
        mm.read()
      mm.work = ''              # clear
      if (mm.eof):
  ...
  while True:  
    ...
    if (mm.work == "word*word*" or mm.work == "text*word*"):
      mm.work = ''              # clear
      ...
      mm.push();
      continue
    if (mm.work == "word*nl*" or mm.work == "text*nl*"):
      mm.work = ''              # clear
      mm.work += mm.tape[mm.cell] # get
      mm.increment()      # ++ 
      mm.work += mm.tape[mm.cell] # get
      ...
      mm.push();
      continue
    if (mm.work == "line*line*" or mm.work == "lineset*line*"):
      mm.work = ''              # clear
      mm.work += mm.tape[mm.cell] # get
      mm.increment()      # ++ 
      mm.work += mm.tape[mm.cell] # get
    ...
    if (mm.eof):
      mm.pop();
      if (mm.work == "word*" or mm.work == "text*" or mm.work == "line*" or mm.work == "lineset*"):
        mm.work = ''              # clear
        mm.work += mm.tape[mm.cell] # get
        mm.work += "\n"
        sys.stdout.write(mm.work) # print

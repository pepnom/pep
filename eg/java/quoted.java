 ...
 public class quoted {
  ...
  public static void main(String[] args) throws Exception { 
    String temp = "";    
    quoted mm = new quoted(new InputStreamReader(System.in)); 
    ...
    while (!mm.eof) {
      ...
      if (mm.workspace.toString().equals("\"")) {
        ...
        if (mm.eof) {
          ...
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append("[Unterminated quote character (\") at line "); /* add */
        ...
        if (mm.workspace.toString().equals("\"\"")) {
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append("[Empty quotes \"\" at line "); /* add */
          mm.workspace.append(mm.linesRead); /* lines */
          mm.workspace.append(" char "); /* add */
          mm.workspace.append(mm.charsRead); /* chars */
          mm.workspace.append("]\n"); /* add */

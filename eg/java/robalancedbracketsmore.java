 ...
 public class robalancedbracketsmore {
   ...
   public robalancedbracketsmore(Reader reader) {
     this.input = reader;
     this.eof = false;
     this.flag = false;
     this.charsRead = 0; 
   ...
   public void increment() {
     this.tapePointer++;
     if (this.tapePointer > robalancedbracketsmore.LENGTH - 1) {
  ...
  public static void main(String[] args) throws Exception { 
    String temp = "";    
    robalancedbracketsmore mm = new robalancedbracketsmore(new InputStreamReader(System.in)); 
    ...
    while (!mm.eof) {
      ...
      while (true) { 
        ...
        if (!mm.workspace.toString().equals("0")) {
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append("Unmatched bracket near line "); /* add */
        ...
        mm.pop();
        mm.pop();
        if (mm.workspace.toString().equals("{*}*") || mm.workspace.toString().equals("(*)*") || mm.workspace.toString().equals("[*]*") || mm.workspace.toString().equals("ob*ob*")) {
          mm.workspace.setLength(0);            /* clear */
        ...
        if (mm.workspace.toString().startsWith("{*")) {
          if (mm.workspace.toString().endsWith("]*") || mm.workspace.toString().endsWith(")*")) {
        ...
        mm.pop();
        if (mm.workspace.toString().equals("{*ob*}*") || mm.workspace.toString().equals("(*ob*)*") || mm.workspace.toString().equals("[*ob*]*")) {
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append("ob*"); /* add */
          mm.push();
          continue parse;
        ...
        if (mm.workspace.toString().startsWith("{*ob*")) {
          if (mm.workspace.toString().endsWith("]*") || mm.workspace.toString().endsWith(")*")) {
            mm.tape[mm.tapePointer].setLength(0); /* put */
            mm.tape[mm.tapePointer].append(mm.workspace); 
            mm.workspace.setLength(0);            /* clear */
        ...
        if (mm.eof) {
          if (mm.workspace.toString().equals("ob*")) {
            mm.workspace.setLength(0);            /* clear */
            mm.workspace.append("brackets look balanced!\n"); /* add */
            System.out.print(mm.workspace); /* print */
            break script;
          }
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append("brackets not balanced.\n"); /* add */
          System.out.print(mm.workspace); /* print */
          break script;
        }
        mm.push();

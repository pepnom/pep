 ...
 public class palindromenospace {
   ...
   public palindromenospace(Reader reader) {
  ...
  public static void main(String[] args) throws Exception { 
    String temp = "";    
    palindromenospace mm = new palindromenospace(new InputStreamReader(System.in)); 
    /* while */ 
    ...
    mm.workspace.append("> Whitespace and non-letters are ignored!.\n"); /* add */
      ...
      while (true) { 
        ...
        if (mm.workspace.toString().equals("pal*pal*")) {
          ...
          if ((mm.workspace.toString().equals(mm.tape.get(mm.tapePointer).toString()))) {
            ...
            mm.tape.get(mm.tapePointer).append(mm.workspace); 
            mm.workspace.setLength(0);            /* clear */
            mm.workspace.append("[palindrome found!] ending at line "); /* add */

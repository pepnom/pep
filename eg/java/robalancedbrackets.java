 ...
 public class robalancedbrackets {
   ...
   public robalancedbrackets(Reader reader) {
     this.input = reader;
     this.eof = false;
     this.flag = false;
     this.charsRead = 0; 
   ...
   public void increment() {
     this.tapePointer++;
     if (this.tapePointer > robalancedbrackets.LENGTH - 1) {
  ...
  public static void main(String[] args) throws Exception { 
    String temp = "";    
    robalancedbrackets mm = new robalancedbrackets(new InputStreamReader(System.in)); 

 ...
 public class word {
  ...
  public static void main(String[] args) throws Exception { 
    String temp = "";    
    word mm = new word(new InputStreamReader(System.in)); 
    ...
    while (!mm.eof) {
      lex: { 
        ...
        // between each word.
        if (mm.workspace.toString().matches("^[ \t\f]+$")) {
          /* while */ 
      ...
      while (true) { 
        ...
        if (mm.workspace.toString().equals("word*word*") || mm.workspace.toString().equals("text*word*")) {
          mm.workspace.setLength(0);            /* clear */
        ...
        if (mm.workspace.toString().equals("line*line*") || mm.workspace.toString().equals("lineset*line*")) {
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append(mm.tape.get(mm.tapePointer)); /* get */
          mm.increment();                 /* ++ */
          mm.workspace.append(mm.tape.get(mm.tapePointer)); /* get */
          ...
          mm.tape.get(mm.tapePointer).append(mm.workspace); 
          mm.workspace.setLength(0);            /* clear */
          mm.workspace.append("lineset*"); /* add */
          mm.push();
          continue parse;
        }
        mm.push();
        ...
        if (mm.eof) {
          mm.pop();
          if (mm.workspace.toString().equals("word*") || mm.workspace.toString().equals("text*") || mm.workspace.toString().equals("line*") || mm.workspace.toString().equals("lineset*")) {
            mm.workspace.setLength(0);            /* clear */
            mm.workspace.append(mm.tape.get(mm.tapePointer)); /* get */
            mm.workspace.append("\n"); /* add */
            System.out.print(mm.workspace); /* print */

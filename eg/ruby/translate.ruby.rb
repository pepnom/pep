  ...
  while true 
    ...
    if (mm.work == ".*word*") then
      ...
      if (mm.work == "restart") then
        ...
        if (mm.work == "0") then
          ...
          mm.work += "restart = true; next # restart"
        end
        if (mm.work == "1") then
          mm.work = ''          # clear
          mm.work += "break"
    ...
    if (mm.work == "word*;*") then
      ...
      if (mm.work == "clip") then
        mm.work = ''          # clear
        mm.work += "if !mm.work.empty? then       # clip \n"
      ...
      if (mm.work == "clop") then
        mm.work = ''          # clear
        mm.work += "if !mm.work.empty? then       # clop \n"
    ...
    if (mm.work == "{*quote*;*" || mm.work == "{*begintext*;*" || mm.work == "{*endtext*;*" || mm.work == "{*class*;*" || mm.work == "commandset*quote*;*" || mm.work == "command*quote*;*") then
      mm.push();
      mm.push();
      mm.push();
    ...
    if (mm.eof) then
      if (mm.work == "commandset*parse>*commandset*" || mm.work == "command*parse>*commandset*" || mm.work == "commandset*parse>*command*" || mm.work == "command*parse>*command*") then
        ...
        # replace 
        if mm.work.length > 0 then 
          mm.work.gsub!("next # restart", "break # restart")
         end
    ...
    if (mm.eof) then
      ...
      if (mm.work.start_with?("parse>")) then
        mm.tape[mm.cell] = mm.work  # put 
        mm.work = ''          # clear

...
func main() {
  ...
  for !mm.eof { 
    ...
    for true { 
      ...
      // between each word.
      if (isInList(" \t\f", mm.work)) {
        /* while */
        for isInList(" \t\f", string(mm.peep)) {
          if mm.eof { break }
          mm.read()
        }
        mm.work = ""          // clear
    ...
    for true {
      ...
      if (mm.work == "word*word*" || mm.work == "text*word*") {
        mm.work = ""          // clear
      ...
      if (mm.work == "line*line*" || mm.work == "lineset*line*") {
        mm.work = ""          // clear
        mm.work += mm.tape[mm.cell] /* get */
        mm.increment()     /* ++ */ 
      ...
      if (mm.eof) {
        mm.pop();
        if (mm.work == "word*" || mm.work == "text*" || mm.work == "line*" || mm.work == "lineset*") {
          mm.work = ""          // clear
          mm.work += mm.tape[mm.cell] /* get */
          mm.work += "\n"
          fmt.Printf("%s", mm.work)    // print

...
func main() {
  ...
  for !mm.eof { 
    ...
    for true { 
      ...
      if (isInRange('a','z', mm.work) || isInRange('A','Z', mm.work)) {
        /* while */
        for isInRange('a','z', string(mm.peep)) {
          if mm.eof { break }
          mm.read()
        }
        if (mm.work != "true" && mm.work != "false" && mm.work != "null" && mm.work != "e" && mm.work != "E") {
          // handle error
          mm.tape[mm.cell] = mm.work  /* put */
          mm.work = ""          // clear
      ...
      // literal tokens
      if (mm.work == "." || mm.work == "," || mm.work == ":" || mm.work == "-" || mm.work == "+" || mm.work == "[" || mm.work == "]" || mm.work == "{" || mm.work == "}") {
        mm.tape[mm.cell] = mm.work  /* put */
        mm.work += "*"
        mm.push();
        break
    ...
    for true {
      ...
      if (mm.work != "E*" && strings.HasPrefix(mm.work, "E*") && !strings.HasSuffix(mm.work,"integer*") && !strings.HasSuffix(mm.work,"-*") && !strings.HasSuffix(mm.work,"+*") && !strings.HasSuffix(mm.work,"number*")) {
        mm.work = ""          // clear
        mm.work += "JSON syntax error at line "
        mm.work += strconv.Itoa(mm.linesRead) /* lines */
        mm.work += " (char "
      ...
      // exponent errors (e/E must be followed by an int or signed int)
      if (mm.work != "E*" && strings.HasSuffix(mm.work, "E*") && !strings.HasPrefix(mm.work,"integer*") && !strings.HasPrefix(mm.work,"sign.integer*") && !strings.HasPrefix(mm.work,"decimal*")) {
        mm.work = ""          // clear
        mm.work += "JSON syntax error at line "
        mm.work += strconv.Itoa(mm.linesRead) /* lines */
        mm.work += " (char "
      ...
      if (mm.work != "-*" && strings.HasPrefix(mm.work, "-*") && !strings.HasSuffix(mm.work,"integer*")) {
        mm.work = ""          // clear
        mm.work += "Json syntax error at line "
        mm.work += strconv.Itoa(mm.linesRead) /* lines */
        mm.work += " (char "
      ...
      if (mm.work != ".*" && strings.HasSuffix(mm.work, ".*") && !strings.HasPrefix(mm.work,"integer*") && !strings.HasPrefix(mm.work,"sign.integer*")) {
        mm.work = ""          // clear
        mm.work += "JSON syntax error at line "
        mm.work += strconv.Itoa(mm.linesRead) /* lines */
        mm.work += " (char "
      ...
      if (strings.HasSuffix(mm.work, ":*") && mm.work != ":*" && !strings.HasPrefix(mm.work,"string*")) {
        mm.work = ""          // clear
      ...
      // catch array errors 
      if (strings.HasPrefix(mm.work, "items*") && mm.work != "items*" && !strings.HasSuffix(mm.work,",*") && !strings.HasSuffix(mm.work,"]*")) {
        mm.work = ""          // clear
      ...
      if (mm.work == "E*sign.integer*" || mm.work == "E*integer*") {
        mm.work = ""          // clear
        mm.work += "^"
        mm.increment()     /* ++ */ 
      ...
      if (mm.work == "integer*exponent*" || mm.work == "sign.integer*exponent*") {
        mm.work = ""          // clear
        mm.work += mm.tape[mm.cell] /* get */
        ...
        if (mm.work != "0" && strings.HasPrefix(mm.work, "0")) {
          mm.work = ""          // clear
          mm.work += "Json syntax error at line "
          mm.work += strconv.Itoa(mm.linesRead) /* lines */
          mm.work += " (char "
      ...
      if (mm.work == "sign.integer*,*" || mm.work == "integer*,*") {
        mm.work = ""          // clear
        mm.work += "number*,*"
        mm.push();
        mm.push();
      ...
      if (mm.work == "decimal*}*" || mm.work == "decimal*]*" || mm.work == "decimal*,*") {
        /* replace */
        mm.work = strings.Replace(mm.work, "decimal*", "number*", -1)
      ...
      // signed numbers
      if (mm.work == "-*integer*" || mm.work == "+*integer*") {
        mm.work = ""          // clear
        mm.work += mm.tape[mm.cell] /* get */
        mm.increment()     /* ++ */ 
      ...
      if (mm.work == "{*string*}*" || mm.work == "{*integer*}*" || mm.work == "{*sign.integer*}*" || mm.work == "{*array*}*" || mm.work == "{*object*}*" || mm.work == "{*value*}*" || mm.work == "{*decimal*}*") {
        mm.work = ""          // clear
        mm.work += "Json syntax error near line "
        mm.work += strconv.Itoa(mm.linesRead) /* lines */
        mm.work += ", char "
      ...
      if (mm.work == "sign.integer*.*integer*") {
        ...
        if (strings.HasPrefix(mm.work, "-0") && mm.work != "-0") {
          mm.work += "Json syntax error at line "
          mm.work += strconv.Itoa(mm.linesRead) /* lines */
          mm.work += " (char "
          mm.work += strconv.Itoa(mm.charsRead) /* chars */
      ...
      // arrays, 
      if (mm.work == "[*items*]*" || mm.work == "[*number*]*") {
        mm.work = ""          // clear
        mm.work += "array*"
        mm.push();
        continue
      ...
      // 
      if (mm.work == "items*,*string*" || mm.work == "items*,*value*" || mm.work == "items*,*array*" || mm.work == "items*,*object*" || mm.work == "items*,*number*") {
        mm.work = ""          // clear
        mm.work += "items*"
        mm.push();
        continue
      ...
      // --------------
      // 4 tokens
      if (mm.work == "items*,*items*,*" || mm.work == "items*,*number*,*") {
        mm.work = ""          // clear
        mm.work += "items*,*"
        mm.push();
        mm.push();
      ...
      if (mm.eof) {
        for mm.pop() {}   /* unstack */ 
        if (mm.work == "object*" || mm.work == "array*" || mm.work == "value*" || mm.work == "string*" || mm.work == "integer*" || mm.work == "decimal*" || mm.work == "number*") {
          for mm.push() {}  /* stack */

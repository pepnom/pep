...
#     >> pep -f compilable.c.pss compilable.c.pss
...
#   ----
#      pep -f compilable.c.pss compile.pss > compile.c
...
testis "#"
jumpfalse block.end.15875
  clear
  read
  testis "\n"
  jumpfalse block.end.14962
    clear
    jump parse
  block.end.14962:
...
testis "lines"
jumpfalse block.end.16840
  clear
  add "ll"
block.end.16840:
testis "chars"
jumpfalse block.end.16872
  clear
  add "cc"
block.end.16872:
# one letter command abbreviations
testis "a"
jumpfalse block.end.16939
  clear
  add "add"
block.end.16939:
testis "k"
jumpfalse block.end.16969
  clear
  add "clip"
block.end.16969:
testis "K"
jumpfalse block.end.16999
  clear
  add "clop"
block.end.16999:
testis "D"
...
block.end.17032:
testis "d"
jumpfalse block.end.17063
  clear
  add "clear"
block.end.17063:
testis "t"
jumpfalse block.end.17094
  clear
  add "print"
block.end.17094:
testis "p"
jumpfalse block.end.17123
  clear
  add "pop"
block.end.17123:
testis "P"
jumpfalse block.end.17153
  clear
  add "push"
block.end.17153:
testis "u"
jumpfalse block.end.17186
  clear
  add "unstack"
block.end.17186:
testis "U"
jumpfalse block.end.17217
  clear
  add "stack"
block.end.17217:
testis "G"
jumpfalse block.end.17246
  clear
  add "put"
block.end.17246:
testis "g"
jumpfalse block.end.17275
  clear
  add "get"
block.end.17275:
testis "x"
jumpfalse block.end.17305
  clear
  add "swap"
block.end.17305:
testis ">"
jumpfalse block.end.17333
  clear
  add "++"
block.end.17333:
testis "<"
jumpfalse block.end.17361
  clear
  add "--"
block.end.17361:
testis "m"
jumpfalse block.end.17391
  clear
  add "mark"
block.end.17391:
testis "M"
...
block.end.17419:
testis "r"
jumpfalse block.end.17449
  clear
  add "read"
block.end.17449:
testis "R"
jumpfalse block.end.17480
  clear
  add "until"
block.end.17480:
testis "w"
jumpfalse block.end.17511
  clear
  add "while"
block.end.17511:
testis "W"
jumpfalse block.end.17545
  clear
  add "whilenot"
block.end.17545:
...
#   
testis "n"
jumpfalse block.end.18023
  clear
  add "count"
block.end.18023:
testis "+"
jumpfalse block.end.18051
  clear
  add "a+"
block.end.18051:
testis "-"
jumpfalse block.end.18079
  clear
  add "a-"
block.end.18079:
testis "0"
jumpfalse block.end.18109
  clear
  add "zero"
block.end.18109:
testis "c"
jumpfalse block.end.18141
  clear
  add "cc"
block.end.18141:
testis "chars"
jumpfalse block.end.18173
  clear
  add "cc"
block.end.18173:
testis "l"
jumpfalse block.end.18205
  clear
  add "ll"
block.end.18205:
testis "lines"
jumpfalse block.end.18237
  clear
  add "ll"
block.end.18237:
testis "^"
jumpfalse block.end.18269
  clear
  add "escape"
block.end.18269:
testis "v"
jumpfalse block.end.18303
  clear
  add "unescape"
block.end.18303:
testis "z"
jumpfalse block.end.18334
  clear
  add "delim"
block.end.18334:
testis "S"
jumpfalse block.end.18365
  clear
  add "state"
block.end.18365:
testis "q"
jumpfalse block.end.18395
  clear
  add "quit"
block.end.18395:
testis "Q"
jumpfalse block.end.18425
  clear
  add "bail"
block.end.18425:
testis "s"
jumpfalse block.end.18456
  clear
  add "write"
block.end.18456:
testis "o"
jumpfalse block.end.18485
  clear
  add "nop"
block.end.18485:
testis "rs"
jumpfalse block.end.18519
  clear
  add "restart"
block.end.18519:
testis "rp"
jumpfalse block.end.18553
  clear
  add "reparse"
block.end.18553:
...
testis ".*word*"
jumpfalse block.end.25204
  clear
  ++
  get
  --
  testis "restart"
  jumpfalse block.end.24882
    clear
    add "jump start"
    put
    clear
...
testis "tapetest*{*"
jumptrue 2 
jump block.end.29011
  # set accumulator == 0
  zero
  testbegins "begin"
  jumpfalse block.end.28304
    clear
    add "testbegins "
  block.end.28304:
  testbegins "end"
  jumpfalse block.end.28343
    clear
    add "testends "
  block.end.28343:
  testbegins "quote"
  jumpfalse block.end.28382
    clear
    add "testis "
  block.end.28382:
  testbegins "class"
  jumpfalse block.end.28424
    clear
    add "testclass "
  block.end.28424:
...
testis "nottapetest*{*"
jumptrue 2 
jump block.end.29980
  # set accumulator == 0
  zero
  testbegins "notbegin"
  jumpfalse block.end.29310
    clear
    add "testbegins "
  block.end.29310:
  testbegins "notend"
  jumpfalse block.end.29352
    clear
    add "testends "
  block.end.29352:
  testbegins "notquote"
  jumpfalse block.end.29394
    clear
    add "testis "
  block.end.29394:
  testbegins "notclass"
  jumpfalse block.end.29439
    clear
    add "testclass "
  block.end.29439:
  # clear the tapecell for testeof and testtape because
  # they take no arguments. 
  testbegins "noteof"
  jumpfalse block.end.29574
    clear
    put
    add "testeof "
  block.end.29574:
  testbegins "nottapetest"
  jumpfalse block.end.29626
    clear
    put
    add "testtape "
  block.end.29626:
...
# format: add "text";
testis "word*quote*;*"
jumpfalse block.end.33089
  clear
  get
  testis "replace"
  jumpfalse block.end.31763
    # error 
...
jumpfalse block.end.34258
  clear
  get
  testis "replace"
  jumpfalse block.end.34138
    clear
    add "command*"
    push
    #---------------------------
...
jumptrue 2 
jump block.end.35566
  testbegins "begin"
  jumpfalse block.end.34971
    clear
    add "testbegins "
  block.end.34971:
  testbegins "end"
  jumpfalse block.end.35011
    clear
    add "testends "
  block.end.35011:
  testbegins "quote"
  jumpfalse block.end.35051
    clear
    add "testis "
  block.end.35051:
  testbegins "class"
  jumpfalse block.end.35094
    clear
    add "testclass "
  block.end.35094:
  # clear the tapecell for testeof and testtape because
  # they take no arguments. 
  testbegins "eof"
  jumpfalse block.end.35229
    clear
    put
    add "testeof "
  block.end.35229:
  testbegins "tapetest"
  jumpfalse block.end.35279
    clear
    put
    add "testtape "
  block.end.35279:
...
jumptrue 2 
jump block.end.36363
  testbegins "notbegin"
  jumpfalse block.end.35838
    clear
    add "testbegins "
  block.end.35838:
  testbegins "notend"
  jumpfalse block.end.35881
    clear
    add "testends "
  block.end.35881:
  testbegins "notquote"
  jumpfalse block.end.35924
    clear
    add "testis "
  block.end.35924:
  testbegins "notclass"
  jumpfalse block.end.35970
    clear
    add "testclass "
  block.end.35970:
  testbegins "noteof"
  jumpfalse block.end.36017
    clear
    put
    add "testeof "
  block.end.36017:
  testbegins "nottapetest"
  jumpfalse block.end.36070
    clear
    put
    add "testtape "
  block.end.36070:
...
jumptrue 2 
jump block.end.37293
  testbegins "begin"
  jumpfalse block.end.36907
    clear
    add "testbegins "
  block.end.36907:
  testbegins "end"
  jumpfalse block.end.36947
    clear
    add "testends "
  block.end.36947:
  testbegins "quote"
  jumpfalse block.end.36987
    clear
    add "testis "
  block.end.36987:
  testbegins "class"
  jumpfalse block.end.37030
    clear
    add "testclass "
  block.end.37030:
  testbegins "eof"
  jumpfalse block.end.37074
    clear
    put
    add "testeof "
  block.end.37074:
  testbegins "tapetest"
  jumpfalse block.end.37124
    clear
    put
    add "testtape "
  block.end.37124:
...
jumptrue 2 
jump block.end.38094
  testbegins "notbegin"
  jumpfalse block.end.37694
    clear
    add "testbegins "
  block.end.37694:
  testbegins "notend"
  jumpfalse block.end.37737
    clear
    add "testends "
  block.end.37737:
  testbegins "notquote"
  jumpfalse block.end.37780
    clear
    add "testis "
  block.end.37780:
  testbegins "notclass"
  jumpfalse block.end.37826
    clear
    add "testclass "
  block.end.37826:
  testbegins "noteof"
  jumpfalse block.end.37873
    clear
    put
    add "testeof "
  block.end.37873:
  testbegins "nottapetest"
  jumpfalse block.end.37926
    clear
    put
    add "testtape "
  block.end.37926:
...
jumptrue 2 
jump block.end.39165
  # indent the assembled code for readability
  testbegins "test*{*"
  jumpfalse block.end.38715
    clear

...
HISTORY
  ...
  28 july 2019
    ...
    trying to change reparse and restart syntax to ".reparse" and
    ".restart" and parse label to "parse>". Also begintext syntax
    to B"text" and E"text"
    
  26 july 2019

    trying to add reparse and <pp> parselabel. also finished coding
